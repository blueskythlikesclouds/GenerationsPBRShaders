...
RLRParam SceneEffect::RLR = { false, 32, 0.8f, 50.0f, 0.1f, 32.0f, 1.0f, 1.0f };
...
HOOK(void, __cdecl, InitializeSceneEffectParameterFile, 0xD192C0, Sonic::CParameterFile* This)
{
    ...
    pRLRParamCategory->CreateParamFloat(&SceneEffect::RLR.MaxSpecularExponent, "MaxSpecularExponent");
