...
public class D3DCompiler
{
    ...
    [DllImport("d3dcompiler_47.dll", CallingConvention = CallingConvention.StdCall, PreserveSig = true, EntryPoint = "D3DCompileFromFile")]
    public static extern int CompileFromFile(
        [MarshalAs(UnmanagedType.LPStr), In] string pSrcData,
        [In] int SrcDataSize,
        [MarshalAs(UnmanagedType.LPStr), In, Optional] string pSourceName,
        [In, Optional] D3DShaderMacro[] pDefines,
